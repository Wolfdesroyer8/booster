...
func mountZfs() error {
	...
	if err := os.MkdirAll("/dev/disk/by-partuuid/", 0755); err != nil {
		return err
	}
	if err := os.Symlink("/dev/sda1", "/dev/disk/by-partuuid/308eb65b-292a-49ca-9cf1-f739b338a77e"); err != nil {
		return err
	}
